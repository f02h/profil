...
def todo_list():
    ...
    if request.GET.save:
        ...
        počasnejePredKoncemHodaLV = request.GET.počasnejePredKoncemHodaL.strip()
        hitrostPredKoncemHodaLV = request.GET.hitrostPredKoncemHodaL.strip()
        hodDV = request.GET.hodD.strip()
        počasnejePredKoncemHodaDV = request.GET.počasnejePredKoncemHodaD.strip()
        ...
        c.execute("UPDATE vars SET value = ? WHERE name LIKE 'počasnejePredKoncemHodaL'", (počasnejePredKoncemHodaLV,))
        ...
        c.execute("UPDATE vars SET value = ? WHERE name LIKE 'počasnejePredKoncemHodaD'", (počasnejePredKoncemHodaDV,))
